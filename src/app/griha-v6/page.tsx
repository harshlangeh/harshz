...
const sections = [
  ...
  },
  {
    ...
    "criteria": [
      ...
      {
        "id": 11,
        "name": "Thermal & Acoustic Comfort",
        "max": 2,
        "type": "Partly Mandatory"
      },
      {
        "id": 12,
        "name": "Maintaining Indoor Air Quality",
        "max": 7,
        "type": "Optional"
      }
    ]
  ...
  {
    "id": 8,
    "title": "Life Cycle Assessment and Costing",
    "max": 8,
    "criteria": [
      {
        "id": 21,
        "name": "Reduction in global warming potential through LCA",
        "max": 5,
        "type": "Optional"
      },
      {
  ...
  {
    "id": 10,
    "title": "Performance Monitoring and Metering",
    "max": 10,
    "criteria": [
      {
        "id": 27,
        ...
        <tr key={c.id} className={`border-b transition-colors hover:bg-white-5 ${c.type === 'Mandatory' ? 'bg-dark-rose' : c.type === 'Partly Mandatory' ? 'bg-rose-10' : ''}`}>
          ...
          <td className="py-3 px-4 text-center">
            <input 
              ...
              className="glass-input focus-ring-orange text-center"
              placeholder="0"
            />
          </td>
