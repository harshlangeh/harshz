...
const data = [
  {
    id: 1, title: "Site Planning", max: 8,
    criteria: [
  ...
  {
    id: 2, title: "Construction Management", max: 9,
    criteria: [
  ...
  {
    id: 4, title: "Occupant Comfort and Well Being", max: 12,
    criteria: [
  ...
  {
    id: 6, title: "Sustainable Building Materials", max: 14,
    criteria: [
  ...
  {
    id: 7, title: "Solid Waste Management", max: 6,
    criteria: [
  ...
  {
    id: 8, title: "Socio-Economic Strategies", max: 6,
    criteria: [
  ...
  {
    id: 9, title: "Performance Monitoring and Validation", max: 8,
    criteria: [
...
export default function GrihaV2015Page() {
  const [scores, setScores] = useState(Array(32).fill(0));
...
const dir = 'src/app/griha-v2015';
if (!fs.existsSync(dir)){
    fs.mkdirSync(dir, { recursive: true });
}
fs.writeFileSync(path.join(dir, 'page.tsx'), componentCode.trim());
console.log('GRIHA V2015 checklist generated.');
